...
import ProductSaltena from './products';

export const Saltena = React.forwardRef<HTMLDivElement>((props, ref) => {
  return (
    <div
      id="Saltena"
    ...
    >
          <Image
        src="/img/saltena/fondoSaltenaMovil.png"
        alt="Fondo"
...
<div id='SaltenaC' className=" flex flex-col 
